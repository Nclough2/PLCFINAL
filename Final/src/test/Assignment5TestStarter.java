...
class Assignment5TestStarter {
	...
	@Test
		//This test writes to the console.  The tester should see that displayed result is same as entered.
	void testWriteInt0() throws Exception {
		String input = """
				int testWrite0()
				int x;
				x <- console;
	...
	@Test
	void testWriteInt1() throws Exception {
		String input = """
				int testWrite1()
				int x;
				x <- console;
